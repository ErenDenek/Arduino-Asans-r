...
void loop() {
  ...
  if (digitalRead(8) == 1 && x == 0) {
    x = 1;
    if (Durum2 == 0) Durum2 = 1;
    else if (Durum2 == 1) Durum2 = 0;
  }
  else if (digitalRead(8) == 0 && x == 1) {
    x = 0;
  }
...
void sens()
{
  ...
  if (ldr2 <= 800)kat = 2;
  if (ldr3 <= 700)kat = 1;
  //Serial.print(kat); Serial.print("\t");
  //  Serial.print(Durum1);Serial.print(Durum2);Serial.println(Durum3);
